...
import com.cometsol.lighttech.Util.NBTHelpers;
import com.cometsol.lighttech.Util.NBTHelpers.BoundInventory;
import com.cometsol.lighttech.Util.NBTHelpers.GlobalVec3;
...
public class LightTechDataComponents {
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<NBTHelpers.GlobalVec3>> BOUND_GLOBAL_VEC3;
    */
    ...
    */
    ...
    static {
        ENTITIYTYPE = COMPONENTS.register("entitytype", () -> DataComponentType.builder().persistent(Codec.STRING).networkSynchronized(ByteBufCodecs.STRING_UTF8).build());
        FLOATINGTICKS = COMPONENTS.register("floatingticks", () -> DataComponentType.builder().persistent(Codec.INT).networkSynchronized(ByteBufCodecs.VAR_INT).build());
        /*
        ...
        BOUND_GLOBAL_VEC3 = COMPONENTS.register("bound_global_vec3", () -> DataComponentType.builder().persistent(GlobalVec3.CODEC).networkSynchronized(GlobalVec3.STREAM_CODEC).build());
        */
        BOUND_GLOBAL_POS = COMPONENTS.register("bound_global_pos", () -> DataComponentType.builder().persistent(GlobalPos.CODEC).networkSynchronized(GlobalPos.STREAM_CODEC).build());
        LEFT_CLICK_ABILITIES = COMPONENTS.register("left_click_abilities", () -> DataComponentType.builder().persistent(Codec.STRING.listOf()).networkSynchronized(ByteBufCodecs.STRING_UTF8.apply(ByteBufCodecs.list())).build());
        /*
        ...
        */
        COPY_AREA_SETTINGS = COMPONENTS.register("copy_area_settings", () -> DataComponentType.builder().persistent(Codec.BOOL).networkSynchronized(ByteBufCodecs.BOOL).build());
        COPY_OFFSET_SETTINGS = COMPONENTS.register("copy_offset_settings", () -> DataComponentType.builder().persistent(Codec.BOOL).networkSynchronized(ByteBufCodecs.BOOL).build());
        COPY_FILTER_SETTINGS = COMPONENTS.register("copy_filter_settings", () -> DataComponentType.builder().persistent(Codec.BOOL).networkSynchronized(ByteBufCodecs.BOOL).build());
        COPY_REDSTONE_SETTINGS = COMPONENTS.register("copy_redstone_settings", () -> DataComponentType.builder().persistent(Codec.BOOL).networkSynchronized(ByteBufCodecs.BOOL).build());
        COPIED_MACHINE_DATA = COMPONENTS.register("copied_machine_data", () -> DataComponentType.builder().persistent(CustomData.CODEC).networkSynchronized(CustomData.STREAM_CODEC).build());
        /*
        ...
        */
        FLUID_CONTAINER = COMPONENTS.register("fluid_container", () -> DataComponentType.builder().persistent(SimpleFluidContent.CODEC).networkSynchronized(SimpleFluidContent.STREAM_CODEC).build());
        FORGE_ENERGY = COMPONENTS.register("forge_energy", () -> DataComponentType.builder().persistent(Codec.INT.orElse(0)).networkSynchronized(ByteBufCodecs.VAR_INT).build());
        FLUID_CANISTER_MODE = COMPONENTS.register("fluid_canister_mode", () -> DataComponentType.builder().persistent(Codec.INT).networkSynchronized(ByteBufCodecs.VAR_INT).build());
        STUPEFY_TARGETS = COMPONENTS.register("stupefy_targets", () -> DataComponentType.builder().persistent(Codec.STRING.listOf()).networkSynchronized(ByteBufCodecs.STRING_UTF8.apply(ByteBufCodecs.list())).build());
        ITEMSTACK_HANDLER = COMPONENTS.register("itemstack_handler", () -> DataComponentType.builder().persistent(ItemContainerContents.CODEC).networkSynchronized(ItemContainerContents.STREAM_CODEC).cacheEncoding().build());
        TOOL_CONTENTS = COMPONENTS.register("tool_contents", () -> DataComponentType.builder().persistent(ItemContainerContents.CODEC).networkSynchronized(ItemContainerContents.STREAM_CODEC).cacheEncoding().build());
        ...
        POTION_AMOUNT = COMPONENTS.register("potion_amount", () -> DataComponentType.builder().persistent(Codec.INT).networkSynchronized(ByteBufCodecs.VAR_INT).build());
        EPIC_ARROW = COMPONENTS.register("epic_arrow", () -> DataComponentType.builder().persistent(Codec.BOOL).networkSynchronized(ByteBufCodecs.BOOL).build());
        CUSTOM_DATA_1 = COMPONENTS.register("custom_data_1", () -> DataComponentType.builder().persistent(CustomData.CODEC).networkSynchronized(CustomData.STREAM_CODEC).build());
        /*
